...
Vagrant.configure("2") do |config|
    ...
    servers.each do |opts|
        config.vm.define opts[:name] do |config|
            ...
            config.vm.network "forwarded_port", guest: 5601, host: 5668
            config.vm.network "forwarded_port", guest: 9200, host: 9228
            config.vm.network "forwarded_port", guest: 9090, host: 9098
            config.vm.network "forwarded_port", guest: 9000, host: 9008
            config.vm.network "forwarded_port", guest: 9100, host: 9198
